return {
  ...
  config = function()
    ...
    -- Lua
    vim.keymap.set("n", "<leader><leader>", function() trouble.toggle("workspace_diagnostics") end,
      { desc = "Trouble toggle" })
    ...
    vim.keymap.set("n", "<leader>qf", function() trouble.toggle("quickfix") end, { desc = "Trouble quickfix" })
  end
}
