...
-- derive the root of your project
...
local config = {
  ...
  cmd = {
    ...
    -- '-jar', vim.fn.glob(home .. '.local/share/nvim/lsp_servers/jdtls/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar'),
