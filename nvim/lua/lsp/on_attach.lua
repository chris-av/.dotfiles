return function(client, bufnr)
  ...
  buf_set_keymap('n', '<leader>da', '<cmd>lua require("debuggers.node").attach()<CR>', opts)
  buf_set_keymap('n', '<leader>dA', '<cmd>lua require("debuggers.node").attachToRemote()<CR>', opts)
  buf_set_keymap('n', '<F3>', '<cmd>lua require("debuggers.node").attachClose()<CR>', opts)
  buf_set_keymap('n', '<F4>', '<cmd>lua require("debuggers.node").attachToRemoteClose()<CR>', opts)
