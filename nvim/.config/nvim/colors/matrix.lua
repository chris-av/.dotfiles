...
local matrix = {
  ...
  ["@lsp.type.class"]              = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.comment"]            = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.decorator"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.enum"]               = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.enumMember"]         = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.event"]              = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.function"]           = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.interface"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.keyword"]            = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.macro"]              = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.method"]             = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.modifier"]           = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.namespace"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.number"]             = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.operator"]           = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.parameter"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.property"]           = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.regexp"]             = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.string"]             = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.struct"]             = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.type"]               = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.typeParameter"]      = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.type.variable"]           = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.abstract"]            = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.async"]               = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.declaration"]         = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.defaultLibrary"]      = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.definition"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.deprecated"]          = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.documentation"]       = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.modification"]        = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.readonly"]            = { fg = 'LightGreen', bg = 'none' },
  ["@lsp.mod.static"]              = { fg = 'LightGreen', bg = 'none' },
  ...
  ["@comment.error"]               = { fg = green, bg = none },
  ["@comment.warning"]             = { fg = green, bg = none },
